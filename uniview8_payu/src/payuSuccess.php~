...
//array(':payu_bank_ref_num' => $payu_bank_ref_num, ':payu_txnid' => $payu_txnid));
 ...
 $update_success = db_query("UPDATE edu_uniview8_payu_response SET payu_mode = :payu_mode, payu_hash = :payu_hash, payu_bank_ref_num = :payu_bank_ref_num, payu_status = :payu_status, payu_udf1 = :udf1, payu_udf2 = :udf2, payu_udf3 = :udf3, payu_udf4 = :udf4, payu_udf5 = :udf5 WHERE payu_txnid = :payu_txnid ", array(':payu_mode' => $payu_mode, ':payu_hash' => $payu_hash, ':payu_bank_ref_num' => $payu_bank_ref_num, ':payu_status' => $payu_status, ':udf1' => $payu_udf1,':udf2' => $payu_udf2, ':udf3' => $payu_udf3, ':udf4' => $payu_udf4,':udf5' => $payu_udf5, ':payu_txnid' => $payu_txnid));
