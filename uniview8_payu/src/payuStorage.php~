...
static function insert($payu_key,$payu_txnid,$payu_amount,$payu_firstname,$payu_email,$payu_phone,$payu_product_info,$payu_serviceprovider,$payu_billdate,$payu_billnumber,$payu_memberid,$payu_transactiondesc,$payu_city,$payu_state,$payu_country,$payu_zip_code,$payu_pg) {
